...
```javascript
import gumbel from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-gumbel@esm/index.mjs';
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-gumbel/tags). For example,

```javascript
import gumbel from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-gumbel@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-gumbel@esm/index.mjs';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-array-gumbel.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-array-gumbel

[test-image]: https://github.com/stdlib-js/random-array-gumbel/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/random-array-gumbel/actions/workflows/test.yml?query=branch:v0.2.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-array-gumbel/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-array-gumbel?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-gumbel.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-gumbel/main
...
[deno-url]: https://github.com/stdlib-js/random-array-gumbel/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-array-gumbel/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-array-gumbel/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-array-gumbel/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-array-gumbel/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-array-gumbel/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-array-gumbel/blob/main/branches.md
